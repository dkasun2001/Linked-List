...
class DoublyCircularLinkedListAnyTypeADT<T> {
  NodeAnyType<T> head;

  public DoublyCircularLinkedListAnyTypeADT() {
    this.head = null;
  }
  ...
  public void deleteAtEnd() {
    ...
    if (head.next == head) { // Only one node
      ...
      NodeAnyType<T> tail = head.prev;
      NodeAnyType<T> newTail = tail.prev;
      newTail.next = head;
      head.prev = newTail;
    }
  }
  ...
  public void displayReverse() {
    ...
    NodeAnyType<T> current = head.prev; // Start from tail
...
public class DoublyCircularLinkedListAnyType {
  public static void main(String[] args) {
    System.out.println("=== Doubly Circular Linked List Any Type Demo ===");

    // Test with Integer type
    System.out.println("\n--- Testing with Integer Type ---");
    DoublyCircularLinkedListAnyTypeADT<Integer> intList = new DoublyCircularLinkedListAnyTypeADT<>();
    ...
    intList.displayReverse(); // Output: Reverse: 5 4 3 2 1
    ...
    DoublyCircularLinkedListAnyTypeADT<String> stringList = new DoublyCircularLinkedListAnyTypeADT<>();
    ...
    stringList.displayReverse(); // Output: Reverse: Java ! World Hello
    ...
    DoublyCircularLinkedListAnyTypeADT<Double> doubleList = new DoublyCircularLinkedListAnyTypeADT<>();
    ...
    // Test edge cases
    System.out.println("\n--- Testing Edge Cases ---");
    DoublyCircularLinkedListAnyTypeADT<Integer> emptyList = new DoublyCircularLinkedListAnyTypeADT<>();
    emptyList.display();
    ...
    DoublyCircularLinkedListAnyTypeADT<String> singleNodeList = new DoublyCircularLinkedListAnyTypeADT<>();
